...
@author: lan
'''
from app.combatsvr.gatenodeservice import remoteserviceHandle
...
def nethandle_3(cmd,dynamicId, characterId,request_proto):
    log.msg("combat nethandle_3 %x %d %d"%(cmd,dynamicId,characterId))
...
@remoteserviceHandle
def startCombat_5(dynamicId, characterId,data):
...
@remoteserviceHandle
def endCombat_6(dynamicId, characterId,data):
