...
fighteffecttime_map[7] = {"id":7,"name":"击杀","desc":"击飞（包括被收回）",};
fighteffecttime_map[8] = {"id":8,"name":"死亡","desc":"死亡（击倒可复活）",};
fighteffecttime_map[9] = {"id":9,"name":"使用完毕","desc":"出手结束（针对整个出招）",};
fighteffecttime_map[10] = {"id":10,"name":"回合结束","desc":"",};
